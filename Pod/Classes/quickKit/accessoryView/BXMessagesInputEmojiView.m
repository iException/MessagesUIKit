...
@interface BXMessagesInputEmojiView() <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation BXMessagesInputEmojiView
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(bxMessagesInputEmojiView:selectedEmoji:)]) {
        [self.delegate bxMessagesInputEmojiView:self selectedEmoji:[self.emojiArray objectAtIndex:indexPath.row]];
    }
}
